...
namespace FlockWise.Infrastructure.Migrations
{
    ...
    [Migration("20251105211336_AddFarmEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.Farm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.LambingRecord", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LambingDateUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.Sheep", b =>
                {
                    ...
                    b.Property<string>("MotheringAbility")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.BirthRecord", b =>
                {
                    ...
                    b.HasOne("FlockWise.Core.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.Field", b =>
                {
                    b.HasOne("FlockWise.Core.Entities.Farm", "Farm")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("FlockWise.Core.Entities.Sheep", b =>
                {
                    b.HasOne("FlockWise.Core.Entities.Farm", null)
                        .WithMany()
                        .HasForeignKey("FarmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
